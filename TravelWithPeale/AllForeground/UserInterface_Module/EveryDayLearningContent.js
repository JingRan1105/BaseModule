...
var EveryDayLearningContent = React.createClass({
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    <Text style={styles.text}>每日学习内容</Text>

                    <TouchableOpacity>
                        <Text onPress={() =>this.onPressBarrierMap()}>
                            点我跳转到相应单词学习界面
                        </Text>
                    </TouchableOpacity>
                </View>
...
module .exports=EveryDayLearningContent;