...
var CooperateTip = React.createClass({
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    <Text style={styles.text}>（大考->合作）今天的任务已完成。是否进行第二天的旅行？</Text>

                    <TouchableOpacity>
                        <Text onPress={() =>this.pressButtonToCooperation()}>
                            点我跳转到合作
                        </Text>
                    </TouchableOpacity>
                </View>
