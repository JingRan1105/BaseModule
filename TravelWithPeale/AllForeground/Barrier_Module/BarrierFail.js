...
var BarrierFail = React.createClass({
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    <Text style={styles.text}>小测失败提示</Text>

                    <TouchableOpacity onPress={this.pressButtonToTip}>
                        <Text>点我跳转到相关知识界面</Text>
                    </TouchableOpacity>
