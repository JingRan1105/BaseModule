...
var Barrier = React.createClass({
    ...
    pressButtonSubmit() {
        ...
        if (navigator) {
            navigator.push({
                //name: '需判断正误后跳转：答对则跳转到BarrierSuccess中；答错则跳转到BarrierFail中',
                //component: 需判断正误后跳转：答对则跳转到BarrierSuccess中；答错则跳转到BarrierFail中,
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    <Text style={styles.text}>小测题目</Text>

                    <TouchableOpacity onPress={this.pressButtonSubmit}>
                        <Text>点我跳转到小测结果页</Text>
                    </TouchableOpacity>
