...
var BarrierSuccess = React.createClass({
    ...
    pressButtonNext() {
        ...
        if (navigator) {
            navigator.push({
                //name: '下一题或下一个场景，看情形你来定',
                //component: 下一题或下一个场景，看情形你来定,
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    <Text style={styles.text}>小测答对</Text>

                    <TouchableOpacity onPress={this.pressButtonNext}>
                        <Text>点我跳转到下一题或下一个场景</Text>
                    </TouchableOpacity>
