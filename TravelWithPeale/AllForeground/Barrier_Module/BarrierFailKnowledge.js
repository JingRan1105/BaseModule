...
var BarrierFailKnowLedge = React.createClass({
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    <Text style={styles.text}>小测失败后的相关知识展示</Text>

                    <TouchableOpacity onPress={this.pressButtonToThisBarrier}>
                        <Text>点我跳回该题目</Text>
                    </TouchableOpacity>
...
module .exports=BarrierFailKnowLedge;
