...
var BarrierTip = React.createClass({
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    <Text style={styles.text}>小测之前的闯关提示</Text>

                    <TouchableOpacity>
                        <Text onPress={() =>this.pressButtonToBarrier()}>
                            点我跳转到小测第一题
                        </Text>
                    </TouchableOpacity>
                </View>
