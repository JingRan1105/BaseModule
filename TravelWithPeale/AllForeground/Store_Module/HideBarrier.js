...
var HideBarrierResult = require('./HideBarrierResult');
...
var HideBarrier = React.createClass({
    ...
    pressButtonSubmit() {
        ...
        if (navigator) {
            navigator.push({
                name: 'HideBarrierResult',
                component: HideBarrierResult,
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    <Text style={styles.text}>隐藏关题目</Text>
