...
var FreeBarrierResult = require('./FreeBarrierResult');
...
var FreeBarrier = React.createClass({
    ...
    pressButtonSubmit() {
        ...
        if (navigator) {
            navigator.push({
                name: 'FreeBarrierResult',
                component: FreeBarrierResult,
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    <Text style={styles.text}>免费获取题目</Text>
