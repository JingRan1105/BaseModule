...
var Scene = require('./../Learning_Module/Scene');
...
var BarrierMap = React.createClass({
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.content}>
                    ...
                    <Text style={styles.text}>闯关地图</Text>

                    <TouchableOpacity>
                        <Text onPress={() =>this.onPressedScence()}>
                            点我跳转到相应情景
                        </Text>
                    </TouchableOpacity>
